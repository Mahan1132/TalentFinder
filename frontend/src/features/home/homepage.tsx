...
export default function Home() {
   ...
   let user: IUser | null = null;
    ...
    //filter by category
    const handleCategoryClick = (category: string) => {    //onValueChange
      ...
      <button className="nav-button" onClick={() => navigate("/login")}>
        Login
                ...
                <header className="hero-section">
                    ...
                    <p>Discover talented professionals and explore their amazing portfolios</p>
                    <input
                        type="text"
                    ...
                    <div className="category-buttons">
                        {["All", "Designer", "Developer", "Photographer", "Marketer", "Consultant"].map((category) => (
                            <button
                            key={category} 
                        ...
                        {userList.map((user) => (
                            <div key={user._id} className="card">
                                <div className="card-info">
                                    ...
                                    <button className="visit-profile-btn" onClick={() => navigate('/profile')}>
                                        {/* `/profile/${user._id}` */}
                                        Visit Profile                                       
                                    </button>                  
                                </div>
